...
/* Function: th_ungetc
	...
	Note:
		Redirected to stdio in initial version of MITH
*/
int      th_ungetc (int ch, ee_FILE *file) {
    return al_ungetc(ch,file);
}
/* Function: th_fputs
