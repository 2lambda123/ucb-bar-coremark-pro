...
encode_one_block(working_state *state, JCOEFPTR block, int last_dc_val,
  ...
  for (k = 1; k < DCTSIZE2;) {
    ...
    vuint8m4_t idx = __riscv_vsll_vx_u8m4(
        __riscv_vle8_v_u8m4((const unsigned char *)cjpeg_natural_order + k, vl),
        1, vl);
    ...
    vuint16m8_t z_iota =
        __riscv_vadd_vx_u16m8(__riscv_viota_m_u16m8(zeros, vl), zero_count, vl);
    vuint16m8_t nz_iota = __riscv_vadd_vx_u16m8(
        __riscv_viota_m_u16m8(nonzeros, vl), nonzero_count, vl);
