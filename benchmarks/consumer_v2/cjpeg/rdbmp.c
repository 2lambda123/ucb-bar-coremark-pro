...
size_t fread_bmp_line(JSAMPROW ptr, size_t size, size_t nelem,
                      cjpparam_t *params);
...
#define GET_4B(array, offset)                                                  \
  ((e_s32)UCH(array[offset]) + (((e_s32)UCH(array[offset + 1])) << 8) +        \
...
/*															*/
size_t fread_bmp_line(JSAMPROW ptr, size_t size, size_t count,
                      cjpparam_t *params) {
