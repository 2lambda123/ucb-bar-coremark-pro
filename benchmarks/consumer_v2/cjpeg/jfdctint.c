...
#define VOP_VV(op, vd, vs2, vs1)                                               \
  __asm__ volatile("v" op ".vv " vd ", " vs2 ", " vs1);
#define VOP_VI(op, vd, vs2, rs1)                                               \
  __asm__ volatile("v" op ".vi " vd ", " vs2 ", " #rs1);
#define VOP_VX(op, vd, vs2, rs1)                                               \
  __asm__ volatile("v" op ".vx " vd ", " vs2 ", %0" : : "r"(rs1));
